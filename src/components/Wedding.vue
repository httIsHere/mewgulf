<template>
  <div class="view-component view-component-part view-component-part-gray view-component__wedding" id="Wedding">
    ...
    <div class="wedding__inner">
      ...
      <p class="translate-support">中字支持：@喜翻译制组 -> <a href="https://www.bilibili.com/video/BV1G7411p7gp" target="_blank" class="resources-link">【泰语中字】Mew&Gulf - 我们的“婚礼” 中字版@喜翻译制组</a></p>
    </div>
  </div>
</template>
<script>
